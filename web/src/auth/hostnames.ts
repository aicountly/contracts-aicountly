 ...
 * contracts.aicountly.com and contracts.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'contracts').trim() || 'contracts'
...
/**
 * `contracts.aicountly.com` and `contracts.gh.aicountly.com` both resolve to
 * `contracts`, which is what the portal expects in authentication_jump.
 */
