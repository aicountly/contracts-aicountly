...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Contracts').trim() || 'Contracts'
 ...
 * with the app on both contracts.aicountly.com and contracts.gh.aicountly.com. That
