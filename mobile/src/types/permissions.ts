/** Permission slugs, mirroring server-php/app/Support/Permissions.php and web/src/types/permissions.ts verbatim — see that file's own header for why this exists. */
